        ...
        <Toolbar className={styles.menuContainer}>
          <div className={styles.navLinks}>
            <Link
              ...
              to="/"
            >
              <Typography variant="h6">NFT SAGA</Typography>
            </Link>
          ...
          <Button
            onClick={activeAcc ? disconnect : connect}
            className={styles.walletBtn}
            variant="outlined"
            style={{ color: "white", border: "0.1rem solid white" }}
          >
            {activeAcc
              ? activeAcc.slice(0, 3) +
                "..." +
                activeAcc.slice(activeAcc.length - 3, activeAcc.length)
              : "Connect"}
          </Button>
        </Toolbar>
      </AppBar>
